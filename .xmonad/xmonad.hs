...
myStartupHook = do
    ...
    spawnOnce "~/./scripts/bash/xmonad/di.sh"  
    spawnOnce "xmodmap /home/chief/.Xmodmap"
...
-- KB_G dmenu scripts
       ...
       -- , ("M-S-d ", spawn "~/./scripts/bash/dmenu/")
        , ("M-S-d o", spawn "~/./scripts/bash/dmenu/dmenumount")
-- KB_G emacs
         , ("M-e", spawn "emacs")
    ...
    -- KB_G prgograms
         ...
         , ("M-c", spawn myEditor)
         , ("M-M1-n", spawn (myTerminal ++ " -e /bin/newsboat -r"))
         , ("M-S-m", spawn "deadbeef")
       ...
       --  , ("M-S-n", spawn myFilemgui)
         ...
         , ("M-S-i", spawn "emacs ~/.xmonad/xmonad.hs")
